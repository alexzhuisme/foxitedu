...
export default function Scan(){
    return (
        <div className="h-screen bg-purple-base grid grid-cols-2">
            <div className="h-full w-108 flex flex-col justify-center items-center">
            ...
            <div className="w-120 flex justify-center items-center">
