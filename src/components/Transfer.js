...
export default function Transfer () {
    return (
        <div className="bg-wave bg-full bg-no-repeat bg-bottom lg:relative w-full h-auto lg:h-screen grid grid-auto overflow-hidden">
            <div className="flex flex-col h-full lg:h-128 w-96 lg:w-full lg:text-left justify-around items-center">
