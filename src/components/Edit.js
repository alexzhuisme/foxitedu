...
export default function Edit(){
    return (
        <div className="grid grid-auto h-screen justify-center items-center">
            <div className="order-3 w-full flex justify-center items-center mx-auto">
                <img src={edit} alt="" className="w-64"/>
            </div>
            <div className="order-1 flex flex-col justify-center items-center lg:items-start">
